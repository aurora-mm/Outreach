---
title: "Outreach — Creative Dashboard"
output: 
...
popup_iframe_p <- lapply(url_list_p, leafpop:::popupIframe, width = 255, height = 438)
...
mapview(Artists, col.regions = "orange", legend = TRUE, layer.name = "Artist Locations",
          ...
          popup = leafpop::popupTable(Artists, zcol = c("artist", "support_me_by", "url"),
...
# contributions = solo tracks + parts in international collaborations
# collaborations = me-centric, only collaborators are counted, not myself. only albums.
# odd tracks on fiat lux
# label = countries of origin of artists on albums, no international collabs
